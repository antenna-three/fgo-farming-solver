...
const Pagination = ({ currentClassName }: { currentClassName?: string }) => {
  ...
  return (
    <div className="pagination">
      <Link href={'/material/' + prevClassName}>
        <a className="page">
          <span className="page prev">{jpClassNames[prevClassName]}</span>
        </a>
      </Link>
      <Link href="/material">
        <a className="page">
          <span className="page top">サーヴァント選択/共通設定</span>
        </a>
      </Link>
      <Link href={'/material/' + nextClassName}>
        <a className="page">
          <span className="page next">{jpClassNames[nextClassName]}</span>
        </a>
      </Link>
      <style jsx>{`
        .pagination {
